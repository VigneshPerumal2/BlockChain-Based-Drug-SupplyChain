...
public class PharmacyJDialog extends javax.swing.JDialog {
    ...
    /**
     * Creates new form PharmacyJDialog
     */
    public PharmacyJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
//        msq.updateMedicine(m);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PharmacyJDialog dialog = new PharmacyJDialog(new javax.swing.JFrame(), true);
